...
function myFunction() {
  ...
  function myCalcFun(){
    var vizzeta = parseFloat(document.getElementById("vizzeta").value);
    var consulting = parseFloat(document.getElementById("consulting").value);
    var expenses = parseFloat(document.getElementById("expenses").value);

        var subTotal = vizzeta;
        var subTotal = vizzeta + consulting;
        var subTotal = subTotal - expenses;

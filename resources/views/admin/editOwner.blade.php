...
@section('title','تعديل مجلس الادارة')
@section('content')
...
<div class="pageheader hidden-xs">
                    <div class="breadcrumb-wrapper">
                         <ol class="breadcrumb">
                            ...
                            <li class="active"> تعديل مجلس الادارة</li>
                         </ol>
                    </div>
                </div>
    <div id="page-content">
                                ...
                                <div class="col-sm-12 eq-box-sm">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <h3 class="panel-title"> تعديل مجلس الادارة</h3>
                                        ...
                                        <!--Block Styled Form -->
                                        <!--===================================================-->
                                        <form  method="post" action="{{Route('owner.update', $owners -> id)}}" enctype="multipart/form-data">
                                        @csrf

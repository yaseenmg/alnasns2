...
<img class="img-fluid" src="{{asset('images/about/'.$about->photo)}}" alt="donate">
</div>
</div>
@endforeach
</div>
...
<!--=====End About Us=====-->
<!--=====Start Owner=====-->
<section class="owner py-3">

<h2 class="H2"> <span class="left"></span>مجلس الإدارة<span class="right"></span></h2>

<div class="col-lg-12 col-sm-12 col-md-6 aos-init" data-aos="fade-down" data-aos-duration="2000">
<div class="donate_img">
<center>
<img class="img-fluid" src="{{asset('images/owner/'.$owners[0]->photo)}}" alt="donate">
</center>
</div>
</div>
</div>

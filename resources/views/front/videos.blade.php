...
<li class="breadcrumb-item active" aria-current="page">فيديوهات</li>
</ol>
</nav>
</div>
<!--End Navigation-->
...
<section class="archive-video section-padding">
...
<iframe style="width:100%"  class="iframevideo" src="{{$video -> url}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
</iframe>
</video>
</div>
...
<!-- <center>
<a href="https://www.youtube.com/channel/UC8L-KYIZuMQwkhYSi-aUk7w" class="btn">شاهد المزيد من الفيديوهات</a>
</center> -->
</div>
</div>
</div>
